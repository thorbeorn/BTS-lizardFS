...
echo "installation of lizardfs CGI serv"
apt-get install -y lizardfs-common  lizardfs-cgiserv lizardfs-adm
systemctl enable lizardfs-cgiserv.service
systemctl start lizardfs-cgiserv.service